...
func generateMsg() string {
	msg := `**This bot will be terminated on 1st march 2023**
>>> **Help**
...
p.s
We are not planning to take over Mio-chan's ITBFess, after 1st march 2023, we will disable all services and delete all data
`
	return msg
}
